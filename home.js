       ...
       <View style={style.con}>
        <ScrollView>
           ...
           <View style={{flexDirection:'row'}}>
            ...
            <Text style={style.more}>View More  <Image source={arrow} style={{height:20,width:20}}/></Text>
           </View>
           <View style={{flexDirection:'row'}}>
           ...
           <View style={{flexDirection:'row'}}>
            ...
            <Text style={style.arrive1}>View All</Text>
        ...
        <View style={style.cart}> 
           ...
           <Text style={style.webpageviewmore}>View more</Text>
        ...
        <View style={style.decorecart}> 
           ...
           <View style={{flexDirection:'row'}}>
           <View style={{flex:1}}>
           <Image source={sofa2} style={style.sofa2}/> 
           ...
           <Text style={style.webpageviewmore2}>View more</Text>
