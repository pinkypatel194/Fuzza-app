...
import  Wooden from'../assets/sofa2.png';
import Lamp  from'../assets/sofa3.png';
import  Flower  from'../assets/sofa4.png';
import  cart from '../assets/sofa5.png';
    ...
    return(   
       <View style={style.Color}>
           ...
           <View style={style.box}>
               ...
               {/* <Text style={style.text1}>Qty : 1  </Text> */}
               <Image source={cart}  style={{height:10,width:10,marginLeft:150,padding:10,backgroundColor:'#FEFEFF',borderRadius:20}}/>      
               </View>
           </View>
           <View style={style.box}>
               <View style={{flexDirection:'row'}}>
           ...
           <View style={style.box}>
               ...
               <Image source={cart}  style={{height:20,width:20,marginLeft:150,padding:10,backgroundColor:'#FEFEFF',borderRadius:10}}/>
               </View>
           </View>
          </View>
