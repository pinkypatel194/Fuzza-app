    ...
    return (
        <View style={styles.con}>
            <ScrollView>
                ...
                <Image source={bedseet} style={styles.bedset} />
                ...
                <View style={{ flexDirection: 'row' }}>
                    <TextInput
                        ...
                        placeholder="Pincode" placeholderTextColor={'#FFFFFF'}
                    />
                    <Text style={styles.checkbox}><Text>Check</Text></Text>
                </View>
                <View>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <View style={styles.similarcart}>
                            <View style={styles.similarcartstyle}>
                                <Image source={bed1} style={{ width: 135, height: 130, marginTop: -10, marginLeft: -8 }} />
                        ...
                        <View style={styles.similarcart}>
                            <View style={styles.similarcartstyle}>
                                <Image source={bed2} style={{ width: 135, height: 130, marginTop: -10, marginLeft: -8 }} />
                                <View style={styles.cartround}><Image source={shoopingbag} style={styles.shoopingbag} /></View>
                                <View style={{ flexDirection: 'row' }}><Text style={styles.buddy}>Bubble Swing Chair</Text>
                                    <Text style={styles.decor1}>Modern Swing Chair</Text>
                                    <View style={{ flexDirection: 'row' }}><Text style={styles.decorprice}>$120</Text>
                                        <Image source={star} style={styles.star1} />
                                        <Text style={styles.startext}>4.5</Text></View>
                                </View>
                            </View>
...
const styles = StyleSheet.create({
    ...
    }, ratingstar:
    {
        ...
        height: 3, width: 15, backgroundColor: '#F5FCFF',
        color: "#F5FCFF", fontWeight: 'bold', marginTop: 25, marginLeft: 20
    }, productnumber: {
        ...
        fontSize: 25,
        color: "#F5FCFF", fontWeight: 'bold', marginTop: 8, marginLeft: 30
    }, descrpiton: {
        color: "#FFFFFF",
        ...
        borderWidth: 2, height: 45, width: 330,
        marginLeft: 10, marginTop: 20,
        borderRadius: 10, borderColor: '#B8BEC3',
        paddingLeft: 20, color: '#D9D9D9'
    }, checkbox:
    {
        height: 41, width: 70,
        marginLeft: -72, marginTop: 22,
        backgroundColor: '#B8BEC3', borderRadius: 2,
