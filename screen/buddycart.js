...
import chair from '../assets/yellowchiar.png'
...
import Chairs11 from '../assets/Chairs1.png'
import Chairs12 from '../assets/Chairs2.png'
const Buddaycart = ({ navigation }) => {
        ...
        <View style={styles.con}>
            <ScrollView>
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <Text style={styles.heading}> Chiar </Text></View>
                <Image source={chair} style={styles.bedset} />
                <Image source={dotline} style={styles.dotline} />
                <View style={{ flexDirection: 'row' }}><Text style={styles.productname}>Quetzal Armchair.....</Text>
