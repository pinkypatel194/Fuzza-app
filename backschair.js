...
import chair from './assets/chair5.png'
...
const Backschair=({navigation})=>
{
    ...
    return(
     ...
     <ScrollView>
       ...
       <View style={{flexDirection:'row'}}><Text style={styles.productname}>Buddy Chairs....</Text>
